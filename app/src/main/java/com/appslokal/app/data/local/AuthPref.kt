package com.appslokal.app.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appslokal.app.data.model.ActionState
import com.appslokal.app.data.model.AuthUser
import com.appslokal.app.util.getObject
import com.appslokal.app.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser> {
        ...
        return if (user == null) {
            ...
            ActionState(message = "Email dan passwoerd gak boleh kosong", isSuccess = false)
